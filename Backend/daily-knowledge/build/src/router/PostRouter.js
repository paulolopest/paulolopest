...
const postBusiness = new PostBusiness_1.PostBusiness(new PostData_1.PostData(), new UserData_1.UserData(), new IdGenerator_1.IdGenerator(), new TokenManager_1.TokenManager());
